...
import { createReservationHall } from "@/app/helper/reservation";
...
export function ReservationConfirm(): React.JSX.Element {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await createReservationHall(reservation, bookings, totalFee, reCaptchaToken);
      router.push("/reservations/hall/overview");
    } catch (error: any) {
      console.error(error);
      setModalTitle(
